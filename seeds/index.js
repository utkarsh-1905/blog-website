...
const seeds = async () => {
  ...
  for (let i = 1; i <= 10; i++) {
    const blog = new Blog({
      ...
      image:"https://images.unsplash.com/photo-1432821596592-e2c18b78144f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80",
      rating:5,
      edited:false,
      created:new Date(),
    });
